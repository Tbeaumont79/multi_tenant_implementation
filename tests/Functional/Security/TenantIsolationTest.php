...
final class TenantIsolationTest extends WebTestCase
{
    ...
    #[Test]
    public function twigUserCannotSwitchToCabinetTheyDontOwn(): void
    {
    ...
    #[Test]
    public function twigUserCanSwitchToTheirOwnCabinet(): void
    {
        $this->client->loginUser($this->loadUser('emma@hotmail.com'));
    ...
    #[Test]
    public function apiUserCannotAccessOtherTenantPatients(): void
    {
    ...
    #[Test]
    public function apiUserCanAccessTheirTenantPatients(): void
    {
        $token = $this->getJwtToken('emma@hotmail.com', 'Titi123!');
